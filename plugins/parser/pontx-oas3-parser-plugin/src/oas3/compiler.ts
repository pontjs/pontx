...
// swagger v2 中 #/components/schemas/ 在 OpenAPI 3 中标准化为了 components，为复用该函数，抽取出 keyword 参数
export function compileTemplate(template: string, keyword = "#/components/schemas/") {
  // 词法分析
