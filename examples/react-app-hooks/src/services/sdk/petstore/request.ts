import { ReactHooksApiMethodsProvider } from "pontx-sdk-core/lib/providers/react-hooks";
...
export const provider = new ReactHooksApiMethodsProvider();

export { ReactHooksApiMethodsProvider, specJSON };
...
export const createSDK = (options = {} as DefaultsType) => {
	...
	const sdkProvider = new ReactHooksApiMethodsProvider({ ...specOptions, ...options});
