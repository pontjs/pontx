...
export const TypeSelector: React.FC<TypeSelectorProps> = (props) => {
  ...
  const popoverContent = (
    <div className="pontx-ui-popover-wrapper">
      <div className="flex flex-col text-smtype-selector-popover pontx-ui-type-selector-popover">
            ...
            <div className="flex flex-col mt-5 w-auto flex-no-wrap">
              ...
              <div className="flex flex-no-wrap">
                <Select
                  ...
                  className="flex-1 w-full pontx-ui-refs-suggest"
                  style={{ width: 410 }}
                  value={$ref}
                  onChange={(ref) => {
                    changeRef(ref);
  ...
  return (
    <Balloon
      ...
      popupClassName="pontx-ui-type-selector-popover-container"
      trigger={
        <div
      ...
      className="pontx-ui-schema-type-selector"
      visible={isOpen}
    >
      {popoverContent}
    </Balloon>
